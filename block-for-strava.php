...
define( 'BLOCK_FOR_STRAVA_VERSION', '1.1.0' );
define( 'BLOCK_FOR_STRAVA_DIR', plugin_dir_path( __FILE__ ) );

require_once BLOCK_FOR_STRAVA_DIR . 'includes/functions.php';
require_once BLOCK_FOR_STRAVA_DIR . 'includes/class-block-for-strava-oauth.php';
require_once BLOCK_FOR_STRAVA_DIR . 'includes/class-block-for-strava-api.php';
